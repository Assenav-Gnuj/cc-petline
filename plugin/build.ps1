...
$built     = Join-Path $crateRoot 'target/release/clawd-pet.exe'
...
Copy-Item $built (Join-Path $pluginBin 'clawd-pet.exe') -Force
Write-Host "Copied clawd-pet.exe -> plugin/bin/" -ForegroundColor Green
